...
class Disposal_soil extends CI_Controller
{

    public function __construct()
    {
        // $this->load->database('disposal_soil_all');
        parent::__construct();
        $this->load->helper('url', 'form');
        $this->load->model('disposalsoil_model');
    }
    ...
    public function index()
    {
        ...
        $data['data_disposal_soil'] = $this->disposalsoil_model->get_all();


        $this->template->display('webgis/disposal_soil/index', $data);
    }
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('webgis/disposal_soil/tambahdata', $data);
    }
    ...
    public function simpan()
    {
        ...
        $this->disposalsoil_model->simpan($data);
    ...
    public function edit($objectid_1)
    {
        ...
        $data['title']   = 'Edit Data disposal_soil';
        $data['data_disposal_soil']   = $this->disposalsoil_model->edit($objectid_1);


        $this->template->display('webgis/disposal_soil/editdata', $data);
    }
    ...
    public function update()
    {
        ...
        $this->disposalsoil_model->update($data, $id);
    ...
    public function hapus($objectid_1)
    {
        ...
        $this->disposalsoil_model->hapus($objectid_1);
    ...
    public function upload_index()
    {
        ...
        $this->template->display('webgis/disposal_soil/formshp', $data);
    }
    ...
    public function do_upload()
    {
        ...
        if (!$this->upload->do_upload('shp') || !$this->upload->do_upload('shx') || !$this->upload->do_upload('dbf')) {
            ...
            $this->template->display('webgis/disposal_soil/shphandler', $data);
        }
    }
    ...
    public function insert_db()
    {
        ...
        $this->disposalsoil_model->insert($data);
