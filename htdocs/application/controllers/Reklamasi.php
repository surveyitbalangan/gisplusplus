...
class Reklamasi extends CI_Controller
{

    public function __construct()
    {
        // $this->load->database('reklamasi_all');
        parent::__construct();
        $this->load->helper('url', 'form');
        $this->load->model('reklamasi_model');
    }
    ...
    public function index()
    {
        ...
        $data['data_reklamasi'] = $this->reklamasi_model->get_all();


        $this->template->display('webgis/reklamasi/index', $data);
    }
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('webgis/reklamasi/tambahdata', $data);
    }
    ...
    public function simpan()
    {
        ...
        $this->reklamasi_model->simpan($data);
    ...
    public function edit($objectid)
    {
        ...
        $data['title']   = 'Edit Data reklamasi';
        $data['data_reklamasi']   = $this->reklamasi_model->edit($objectid);


        $this->template->display('webgis/reklamasi/editdata', $data);
    }
    ...
    public function update()
    {
        ...
        $this->reklamasi_model->update($data, $id);
    ...
    public function hapus($objectid)
    {
        ...
        $this->reklamasi_model->hapus($objectid);
    ...
    public function upload_index()
    {
        ...
        $this->template->display('webgis/reklamasi/formshp', $data);
    }
    ...
    public function do_upload()
    {
        ...
        if (!$this->upload->do_upload('shp') || !$this->upload->do_upload('shx') || !$this->upload->do_upload('dbf')) {
            ...
            $this->template->display('webgis/reklamasi/shphandler', $data);
        }
    }
    ...
    public function insert_db()
    {
        ...
        $this->reklamasi_model->insert($data);
