<script type="text/javascript">
	$(window).on("load", function() {		
		...
		function load_data(cari){
			$.ajax({
				type : 'POST',
				url  : '<?=base_url()?>kategori/load_data',
				data : {'cari':cari},
				cache: false,
				beforeSend: function() {
				  NProgress.start();
	        ...
	        <div class="box-body">
	        	<div class="input-group">
					<div class="input-group-btn">
						...
						<input type="text" id="txtCari" class="form-control input-sm pull-right" style="width:250px;" placeholder="Cari Nama Kategori..."/>			          	
					</div>							
				</div>
	        	<div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">					
					<div class="form-group">
							<label class="control-label" for="txtNama">Kategori</label>
