<script type="text/javascript">
	$(window).on("load", function() {
		...
		function simpan(){
			...
			if (inisial.length==0) {
				alert('Nama Inisial tidak boleh kosong !!!');
				$('#txtInisial').focus();
				return false;
			}
			...
			$.ajax({
				type : 'POST',
				url  : '<?=base_url()?>kelompok/simpan',
				data : {"kode":kode,"nama":nama,"inisial":inisial},
				cache: false,
		...
		function load_data(cari){
			$.ajax({
				type : 'POST',
				url  : '<?=base_url()?>kelompok/load_data',
				data : {'cari':cari},
				cache: false,
				beforeSend: function() {
				  NProgress.start();
...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Kelompok Dokumen</li>
		</ol>
	</section>
	        ...
	        <div class="box-body">
	        	<div class="input-group">	
							<div class="input-group-btn">
									...
									<input type="text" id="txtCari" class="form-control input-sm pull-right" style="width:250px;" placeholder="Cari Nama Kelompok..."/>			          	
							</div>							
			    	</div>
	        	<div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">					
					<div class="form-group">
							<label class="control-label" for="txtNama">Kelompok :</label>
							<input type="text" class="form-control" id="txtNama" size="5"/>
							<input type="hidden" class="form-control" id="txtKode" size="5"/>
					</div>
					<div class="form-group">
							<label class="control-label" for="txtInisial">Inisial :</label>
							<input type="text" class="form-control" id="txtInisial" size="5"/>
					</div>                   
				</div>
