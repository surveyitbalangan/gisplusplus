      ...
      if ($data->num_rows()>0) {
        foreach ($data->result_array() as $db) {          
          ...
          <tr class="baris">
            ...
            <td class="col_name"><?=$db['KELOMPOK'];?></td>
            <td class="col_inisial"><?=$db['INISIAL'];?></td>
            <td align="center">            
