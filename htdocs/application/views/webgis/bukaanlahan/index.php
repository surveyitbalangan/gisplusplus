...
<?php
        ...
        $url = "http://localhost:8000/api/bukaanlahan/?format=json";
    ...
    <section class="content" >
        ...
        <a href="<?php echo base_url() ?>/bukaanlahan/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php

        // var_dump($data);
        $arr = $data_bukaanlahan;
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td><?= strtoupper($x->use) ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>bukaanlahan/edit/<?php echo $x->objectid_1 ?>" class="btn btn-sm btn-success">Edit</a>
       ...
       <!-- Modal content--> 
        <div class="modal-content"> 
           <div class="modal-body" style="padding:10px;"> 
             ...
             <a href="<?php echo base_url() ?>bukaanlahan/hapus/${objectid}" class="btn btn-danger">Hapus</a>
