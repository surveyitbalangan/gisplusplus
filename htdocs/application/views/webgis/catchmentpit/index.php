...
<?php
        ...
        $url = "http://localhost:8000/api/catchmentpit/?format=json";
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Data catchmentpit</li>
        </ol>
    </section>
    <section class="content" >
        <?php echo $this->session->flashdata('notif') ?>
        <a href="<?php echo base_url() ?>/catchmentpit/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php

        // var_dump($data);
        $arr = $data_catchmentpit;
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a href="<?php echo base_url() ?>catchmentpit/edit/<?php echo $x->objectid_1 ?>" class="btn btn-sm btn-success">Edit</a>
       ...
       <!-- Modal content--> 
        <div class="modal-content"> 
           <div class="modal-body" style="padding:10px;"> 
             ...
             <a href="<?php echo base_url() ?>catchmentpit/hapus/${objectid}" class="btn btn-danger">Hapus</a>
