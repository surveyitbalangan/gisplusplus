...
<!-- <?php
        ...
        $url = "http://localhost:8000/api/disposal_soil/?format=json";
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Data disposal_soil Soil</li>
        </ol>
    </section>
    <section class="content" >
        <?php echo $this->session->flashdata('notif') ?>
        <a href="<?php echo base_url() ?>/disposal_soil/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php

        // var_dump($data);
        $arr = $data_disposal_soil;
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a href="<?php echo base_url() ?>disposal_soil/edit/<?php echo $x->objectid_1 ?>" class="btn btn-sm btn-success">Edit</a>
       ...
       <!-- Modal content--> 
        <div class="modal-content"> 
           <div class="modal-body" style="padding:10px;"> 
             ...
             <a href="<?php echo base_url() ?>disposal_soil/hapus/${objectid}" class="btn btn-danger">Hapus</a>
