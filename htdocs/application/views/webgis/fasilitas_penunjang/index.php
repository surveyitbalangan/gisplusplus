...
<?php
        ...
        $url = "http://localhost:8000/api/fasilitas_penunjang/?format=json";
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Data Bukaan Lahan</li>
        </ol>
    </section>
    <section class="content" >
        <?php echo $this->session->flashdata('notif') ?>
        <a href="<?php echo base_url() ?>/fasilitas_penunjang/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php

        // var_dump($data);
        $arr = $data_fasilitas_penunjang;
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td><?= strtoupper($x->land_use) ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>fasilitas_penunjang/edit/<?php echo $x->objectid ?>" class="btn btn-sm btn-success">Edit</a>
       ...
       <!-- Modal content--> 
        <div class="modal-content"> 
           <div class="modal-body" style="padding:10px;"> 
             ...
             <a href="<?php echo base_url() ?>fasilitas_penunjang/hapus/${objectid}" class="btn btn-danger">Hapus</a>
