<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class='col-md-12'>
            <?= form_open('pit/update') ?>
        </div>
        <input id='objectid' type="hidden" name="objectid" value='<?= $data_pit->objectid_1 ?>'>
        <div class="form-group">
            <label for="text">Tanggal</label>
            <input type="date" name="date" class="form-control" value="<?php echo substr($data_pit->date, 0, 10) ?>" placeholder="Date">
