...
<?php
        ...
        $url = "http://localhost:8000/api/pit/?format=json";
    ...
    <section class="content" >
        ...
        <a href="<?php echo base_url() ?>/pit/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a href="<?php echo base_url() ?>pit/edit/<?php echo $x->objectid_1 ?>" class="btn btn-sm btn-success">Edit</a>
