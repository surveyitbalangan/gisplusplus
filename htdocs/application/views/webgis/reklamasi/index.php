...
<!-- <?php
        ...
        $url = "http://localhost:8000/api/reklamasi_all/?format=json";
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Data Reklamasi</li>
        </ol>
    </section>
    <section class="content" >
        <?php echo $this->session->flashdata('notif') ?>
        <a href="<?php echo base_url() ?>/reklamasi/do_upload/" class="btn btn-md btn-success">Tambah Data</a>
        <?php
    ...
    <table class='table table-dark m-4'>
            ...
            ?>
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a href="<?php echo base_url() ?>reklamasi/edit/<?php echo $x->objectid ?>" class="btn btn-sm btn-success">Edit</a>
       ...
       <!-- Modal content--> 
        <div class="modal-content"> 
           <div class="modal-body" style="padding:10px;"> 
             ...
             <a href="<?php echo base_url() ?>reklamasi/hapus/${objectid}" class="btn btn-danger">Hapus</a>
