                ...
                <div class="row">
					...
					<div class="col-md-3 col-sm-12">
						<div class="form-group has-feedback">							
							<input type="text" id="txtCari" class="form-control input-sm pull-right"  placeholder="Cari Tahun..."/>			          	
			...
			<div class="modal-content">
				...
				<div class="modal-body">					
					<div class="form-group">
                        <label class="control-label" for="txtNama">Tahun :</label>
